...
var KTScroll = function(e, t) {
    ...
    if (e) {
        var i = { saveState: !0 },
            ...
            s = function() { var e = m(f()); return e instanceof Function ? e.call() : null !== e && "string" == typeof e && "auto" === e.toLowerCase() ? u() : e },
            u = function() {
            ...
            d = function(e) { var t = 0; return null !== e && (t += parseInt(KTUtil.css(e, "height")), t += parseInt(KTUtil.css(e, "margin-top")), t += parseInt(KTUtil.css(e, "margin-bottom")), KTUtil.css(e, "border-top") && (t += parseInt(KTUtil.css(e, "border-top"))), KTUtil.css(e, "border-bottom") && (t += parseInt(KTUtil.css(e, "border-bottom")))), t },
            c = function(e) { var t = 0; return null !== e && (t += parseInt(KTUtil.css(e, "margin-top")), t += parseInt(KTUtil.css(e, "margin-bottom")), t += parseInt(KTUtil.css(e, "padding-top")), t += parseInt(KTUtil.css(e, "padding-bottom")), KTUtil.css(e, "border-top") && (t += parseInt(KTUtil.css(e, "border-top"))), KTUtil.css(e, "border-bottom") && (t += parseInt(KTUtil.css(e, "border-bottom")))), t },
            m = function(e) {
            ...
            f = function() { return m("height") ? "height" : m("min-height") ? "min-height" : m("max-height") ? "max-height" : void 0 };
        KTUtil.data(e).has("scroll") ? n = KTUtil.data(e).get("scroll") : r(), n.update = function() { return a() }, n.getHeight = function() { return s() }, n.getElement = function() { return n.element }, n.destroy = function() { KTUtil.data(n.element).remove("scroll") }
    }
};
...
var KTSticky = function(e, t) {
    ...
    if (null != e) {
        var r = { offset: 200, releaseOffset: 0, reverse: !1, animation: !0, animationSpeed: "0.3s", animationClass: "animation-slide-in-down" },
            ...
            u = function() { var t = parseFloat(KTUtil.css(n.element, "height")); return t += parseFloat(KTUtil.css(n.element, "margin-top")), t += parseFloat(KTUtil.css(n.element, "margin-bottom")), KTUtil.css(e, "border-top") && (t += parseFloat(KTUtil.css(n.element, "border-top"))), KTUtil.css(e, "border-bottom") && (t += parseFloat(KTUtil.css(n.element, "border-bottom"))), t },
            d = function(e) {
