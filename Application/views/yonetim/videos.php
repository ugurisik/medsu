                    ...
                    <div class="card my-3 card-custom card-stretch">
                        ...
                        <div class="card-body">
                            <video width="100%" controls>
                                <source src="<?= SITE_URL . $file ?>" type="video/mp4">
                                <source src="movie.ogg" type="video/ogg">
                                Your browser does not support the video tag.
                            </video>
                            <div class="d-flex flex-column align-items-center">
                                <img alt="" class="max-h-65px" style="max-height: 65px;" src="<?= SITE_URL . $file ?>">
                                <a href="<?= SITE_URL . $file ?>" target="_blank" rel="noopener noreferrer">
                ...
                <form class="form" action="none" id="kt_modal_upload_form">
                    ...
                    <div class="modal-body pt-10 pb-15 px-lg-17">
                        ...
                        <div class="form-group">
                            ...
                            <!--end::Dropzone-->
                            <!--begin::Hint-->
                            <span class="form-text fs-6 text-muted"></span>
                            <!--end::Hint-->
                        </div>
                        <!--end::Input group-->
                    </div>
...
<script>
    ...
    function dropZone() {
        var myDropzone = new Dropzone("#modal_upload", {
            url: "<?= ADMIN_URL ?>files/uploadVideos",
            paramName: "file",
            maxFiles: 5,
            acceptedFiles: ".mp4,.mov,.mkv,.avi,.mpg,.webm,.gif,.m4v",
            maxFilesize: 500,
            addRemoveLinks: true,
